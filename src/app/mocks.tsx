...
export const timePeriods: TimePeriod[] = [
  {
    ...
    description: "Horários realizados no período matutino",
  },
  {
    id: "afternoon",
    title: "Vespertino",
    ...
    description: "Horários realizados no período vespertino",
  },
  {
    id: "evening",
    title: "Noturno",
    ...
    description: "Horários realizados no período noturno",
  },
];
